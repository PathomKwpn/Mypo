    ...
    <div className="sm:min-h-[100vh] bg-[#f5f5f5] flex flex-col items-center py-[70px] px-[30px] ">
      ...
      <div>
        <ul className="grid grid-cols-3 sm:grid-cols-3 gap-2 sm:gap-4 lg:gap-6 mb-5">
          <li className="flex justify-center w-[70px] h-[70px] sm:w-[100px] sm:h-[100px] md:w-[140px] md:h-[140px] lg:w-[160px] lg:h-[160px] font-bold p-2 rounded-2xl shadow-md border-2">
            <img className="" src="./image/skill_logo/html.png" alt="" />
          </li>
          <li className="flex justify-center w-[70px] h-[70px] sm:w-[100px] sm:h-[100px] md:w-[140px] md:h-[140px] lg:w-[160px] lg:h-[160px] font-bold p-2 rounded-2xl shadow-md border-2">
            <img className="" src="./image/skill_logo/css.png" alt="" />
          </li>
          <li className="flex justify-center w-[70px] h-[70px] sm:w-[100px] sm:h-[100px] md:w-[140px] md:h-[140px] lg:w-[160px] lg:h-[160px] font-bold p-2 rounded-2xl shadow-md border-2">
            <img className="" src="./image/skill_logo/js.png" alt="" />
          </li>
          <li className="flex justify-center w-[70px] h-[70px] sm:w-[100px] sm:h-[100px] md:w-[140px] md:h-[140px] lg:w-[160px] lg:h-[160px] font-bold p-2 rounded-2xl shadow-md border-2">
            <img
